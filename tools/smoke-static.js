...
requireIncludes('const HOSTILE_FLYOVER_CHANCE = 0.45;', 'hostile flyover probability');
requireIncludes('function setPlaneEngineAppearance(', 'friendly/hostile engine appearance switch');
requireIncludes('function collectEligibleAntiAirTurrets(', 'registered anti-air turret collection');
requireIncludes('function canTurretsEngageActivePlane(', 'central hostile-plane engagement predicate');
requireIncludes('function fireAntiAirShot(', 'pooled anti-air projectile firing');
requireIncludes('function spawnPlaneHitSmoke(', 'pooled plane impact smoke');
requireIncludes('function resetAntiAirStateForNewFlight(', 'anti-air flight lifecycle reset');
